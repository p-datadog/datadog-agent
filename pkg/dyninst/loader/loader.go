...
//
// Per-CPU counters; sum across cores for a process-wide total.
type RuntimeStats struct {
	...
	// runtime.recovery on this CPU.
	RecoveryFires uint64
	// RecoveryEvictedFrames is the cumulative number of in_progress_calls
	// slots evicted by recovery firings on this CPU. A single recovery
	// can evict 0 or more frames depending on how many probed frames sit
	// in the unwound region.
