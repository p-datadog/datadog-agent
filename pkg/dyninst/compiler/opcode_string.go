...
func _() {
	...
	_ = x[OpcodePanicUnwindPrepare-49]
	_ = x[OpcodePanicUnwindEvictSlots-50]
}

const _Opcode_name = ""

var _Opcode_index = [...]uint16{0, 7, 11, 17, 24, 45, 56, 64, 82, 98, 116, 130, 142, 162, 182, 204, 217, 240, 258, 275, 288, 305, 328, 341, 357, 371, 386, 400, 411, 424, 438, 452, 468, 488, 501, 515, 533, 546, 563, 570, 585, 599, 615, 633, 652, 669, 696, 717, 735, 752, 770, 791}
