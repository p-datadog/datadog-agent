...
//
// All offset/size fields are byte offsets resolved from DWARF. The cache
// fields are optional: if cacheStartOffset == 0 and cacheEndOffset == 0
// (i.e. CacheResolved is false) the BPF runtime skips the cache lookup and
// the decoder formats the timestamp in UTC.
