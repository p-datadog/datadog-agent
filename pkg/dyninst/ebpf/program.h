...
// Cumulative stats aggregated throughout probe lifetime, per-CPU. The
// throttling counters are written by probe_run_with_cookie; the
// recovery_* counters are written by the SM_OP_PANIC_UNWIND_* opcodes.
