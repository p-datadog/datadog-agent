...
require go.opentelemetry.io/collector/extension/xextension v0.151.0 // indirect

require go.opentelemetry.io/collector/extension/extensionauth v1.57.0 // indirect

require go.opentelemetry.io/collector/config/configoptional v1.57.0 // indirect
